...
const MSG_KEY_DELIVER: String = "[i]{item} was delivered to the escape shuttle, {remain_count} remaining.[/i]"
const MSG_KEY_SELF_DELIVER: String = "[i]You deliver {item} to the escape shuttle, {remain_count} remaining.[/i]"
